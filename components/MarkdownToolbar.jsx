...
const MarkdownToolbar = ({ getEditorView, markdown, onHelp, showLineNumbers, onToggleLineNumbers }) => {
    ...
    >
      ...
      <label className='relative shrink-0'>
        ...
        <select
          ...
          defaultValue=''
          className='h-9 rounded-md border border-slate-300 bg-white px-3 pr-8 text-sm text-slate-800 dark:border-slate-600 dark:bg-slate-900 dark:text-white'
