...
const Pagination = ({ totalPages, postName }) => {
  const router = useRouter();

  if (!totalPages || !postName) {
    return null;
  }
  ...
  return (
    <div className="flex justify-center my-8">
      ...
      {!prevDisabled && <Previous currentPageNo={currentPage} postName={postName} />}
      ...
      {!nextDisabled && (
      <Next currentPage={currentPage} totalPages={totalPages} postName={postName} />)}
    </div>
  );
};
