...
const ErrorMessage = ({ message }) => (
  <p className="text-red-500 dark:text-red-300 text-xs italic">{message}</p>
);
...
const ContactForm = () => {
  ...
  return (
    <div className="relative container mx-auto py-4 md:mb-4 px-4 md:px-2">
      <h2 className="flex justify-center lg:text-3xl text-bold leading-normal mt-8">
        Want to Contact me?
      </h2>
      <div className="flex font-semibold items-center justify-center text-bold leading-normal mb-8">
        ...
        <Link href="http://linkedin.com/in/pennowtech">
          <a className="text-red-400 dark:text-pink-400 ">&nbsp; linkedin</a>
        </Link>
      </div>
