...
export const QuickAddModal = ({ isOpen, initialMode = 'issue', onClose, onBookCreated }) => {
  ...
  return (
    ...
    >
      <div
        className='relative w-full max-w-lg overflow-hidden rounded-2xl border border-slate-700 bg-slate-900 p-6 shadow-2xl backdrop-blur-xl'
      ...
      >
        ...
        <div className='flex items-center justify-between border-b border-slate-800 pb-4'>
          <div className='flex items-center gap-2'>
            ...
            <button
              ...
              className='flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium text-slate-400 hover:text-emerald-400 hover:bg-slate-800 transition'
            >
        ...
        {/* Success Alert */}
        {successMessage && (
          <div className='mt-4 flex items-center gap-2 rounded-xl bg-emerald-950/80 border border-emerald-500/40 p-3 text-xs font-bold text-emerald-300'>
          ...
          <form onSubmit={handleCreateIssue} className='mt-4 space-y-4'>
            <div className='grid grid-cols-2 gap-3'>
              <div>
                ...
                <select
                  ...
                  className='w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-xs text-slate-100 outline-none focus:border-cyan-500'
                >
            ...
            <div>
              ...
              <input
                ...
                className='w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-xs text-slate-100 placeholder-slate-500 outline-none focus:border-cyan-500'
              />
            </div>
        ...
        {mode === 'book' && (
          <form onSubmit={handleCreateBook} className='mt-4 space-y-4'>
            <div className='grid grid-cols-2 gap-3'>
              <div>
                ...
                <input
                  ...
                  className='w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-xs text-slate-100 placeholder-slate-500 outline-none focus:border-amber-500'
                />
              </div>
            ...
            <div className='grid grid-cols-3 gap-3'>
              <div>
                <label className='block text-xs font-medium text-slate-400 mb-1'>Shelf</label>
                <select
                  value={bookShelf}
                  onChange={(e) => setBookShelf(e.target.value)}
                  className='w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-xs text-slate-100 outline-none focus:border-amber-500'
                >
              ...
              <div>
                <label className='block text-xs font-medium text-slate-400 mb-1'>Current Page</label>
                <input
                  type='number'
                  min='0'
              ...
              <div>
                <label className='block text-xs font-medium text-slate-400 mb-1'>Total Pages</label>
                <input
                  type='number'
                  min='1'
            ...
            <div>
              <label className='block text-xs font-medium text-slate-400 mb-1'>Personal Notes / Takeaways</label>
              <textarea
                rows={3}
                value={bookNotes}
