            ...
            <div className="w-full md:w-6/12 px-4">
              <div className="relative flex flex-col min-w-0 mb-8">
                ...
                <div className="relative flex flex-col min-w-0 mb-8">
                    ...
                    <p className="mb-4 font-Yantramanav">Worked with various networking protocols, like &nbsp;TCP, IPV4,
                        IPv6, DHCP, SNMP, ARP, etc.</p>
                </div>
            </div>
            <div className="w-full md:w-6/12 px-4">
              <div className="relative flex flex-col min-w-0 mb-8">
          ...
          <div className="w-full md:w-4/12 lg:w-4/12 px-4 mr-auto ml-auto">
              <div className="justify-center flex flex-wrap relative">
                  ...
                  <div className="my-4 w-full lg:w-6/12 px-4 lg:mt-16">
                      <TechCard color="yellow-500" className="bg-yellow-500 text-yellow-500 mb-4"
                                icon={<IoLogoJavascript/>} text="JavaScript"/>
                      <TechCard color="green-600" className="bg-green-600  text-green-600 mb-4" icon={<SiQt/>}
                                text="Qt, QML"/>
                  </div>
              </div>
          </div>
