  ...
  const profileHighlights = [
    {
      ...
      text: t(
        ...
        'More than 18 years of architecture and engineering experience across medical devices, high-frequency trading, autonomous driving, microservices, embedded systems, and network protocols.'
      )
    },
    {
      icon: FaCode,
      text: t(
        ...
        'Hands-on development expertise spanning C, modern C++, MATLAB, Rust, and Python, with particular depth in embedded C++ and performance-sensitive software.'
      )
    },
    {
      icon: FaMicrochip,
      text: t(
        ...
        'Dependable service and data-platform design using FastAPI, Actix Web, gRPC, PostgreSQL, MongoDB, Redis, SQLAlchemy, and Diesel.'
      )
    },
    {
      icon: FaNetworkWired,
      text: t(
        ...
        'Systems expertise covering Docker, Kubernetes, Ansible, Argo CD, TCP/IP, SOME/IP, DHCP, SNMP, IPv4/6, CAN, and proprietary protocols.'
      )
    },
    {
      icon: FaLightbulb,
      text: t(
        'aboutSection.highlight5',
        'A solution-focused approach to turning complex requirements into robust software that teams can confidently operate, maintain, and evolve.'
      )
    }
  ];
          ...
          <div className='px-5 md:px-8'>
            <header className='mx-auto mt-4 max-w-3xl text-center md:mt-5'>
              ...
              <p className='m-0 font-Monda text-sm font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-200'>
                {t('aboutSection.location', 'Germany · Architecture, systems and software engineering')}
              </p>
            </header>
          </div>
