...
const AboutSection = ({ classProps }) => (
  <div className={`${classProps} block -mb-20`}>
        ...
        <div className='relative flex flex-col min-w-0 break-words bg-white dark:bg-gray-500 w-full mb-6 shadow-xl rounded-lg -mt-64'>
          <div className='md:px-6'>
            ...
            <div className='text-center my-4'>
              <h2 className='font-semibold leading-normal mb-2'>Sukhdeep Singh</h2>
              <div className='text-sm leading-normal mt-0 mb-2 font-bold uppercase'>
                <i className='fas fa-map-marker-alt mr-2 text-lg' />
                Germany
              </div>
              <div className='mb-2 font-Monda font-bold text-gray-500 dark:text-slate-200 mt-2'>
                <i className='fas fa-briefcase mr-2 text-lg' />
                Senior Solution Architect
              </div>
            </div>
            <div className='py-4 lg:px-4 border-t border-blueGray-200 text-center max-w-screen-md mx-auto'>
              <div className='flex flex-wrap justify-center'>
                  ...
                  <div className='mb-4'>
                    <ul className='list-none text-left'>
                      <li className='mb-4'>
                        ...
                        Hey there! It&apos;s great to meet you. I&apos;m excited to tell you a bit about my background as a
                        Software Architect.
                      </li>
                      <li className='mb-4'>
                        <GrStackOverflow className='inline-block mr-2' />
                        I&apos;ve over 15 years of experience in various technologies. A few of them includes Medical devices,
                        Automative, Satellite communications, Embedded systems, Network programming, and Data analytics.
                      </li>
                      <li>
                        <i className='fas fa-briefcase mr-2' />
                        I&apos;m experienced in all phases of the SDLC and Agile modeling: design, development, testing, and
                        management.
                      </li>
                      <li>
                        <i className='fas fa-code mr-2' />
                        In addition to my vast experience in Architecture & Design, I also have a strong development background in
                      ...
                      <li>
                        ...
                        This website is all about my technical and travelling life. Yes, I like traveling a lot.
                      </li>
                    </ul>
                  </div>
