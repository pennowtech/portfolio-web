    ...
    <div className='grow rounded-lg '>
      <div className='relative rounded-lg'>
        <div className='relative rounded-t-lg overflow-hidden'>
          <Image src={thumbnailUrl} alt='...' className='object-cover w-full' width={700} height={365} />
          ...
          <div className='relative -mt-10 bg-slate-600 dark:bg-gray-800'>
            ...
            >
              <svg
                ...
                y='0'
              >
                <polygon className='text-slate-600 dark:text-gray-800  fill-current' points='2560 0 2560 100 0 100' />
              </svg>
            </div>
