  ...
  return (
    <div className="max-w-[100%] block rounded-lg overflow-hidden shadow-sm  bg-slate-50  dark:bg-gray-700 mb-12">
      <div className="rounded-lg">
        <div
          className="relative grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 lg:gap-8 rounded-l-lg overflow-hidden"
        >
          ...
          <div className="md:col-span-2 relative">
            ...
            <div className="px-6 py-2">
              <PostExcerpt
                className="text-lg leading-8 hidden wide:block lg:mb-4"
