...
const projects = [
  {
    title: 'Rusty CAN Studio',
    image: '/projects/rusty-can-studio.jpg',
    imageAlt: 'Engineering workstation visualizing CAN bus traffic and embedded network signals',
    description:
    ...
    highlights: ['Live and offline trace analysis', 'Profile-driven protocol decoding', 'Repeatable test simulation'],
    href: 'https://github.com/pennowtech/rusty-can-studio',
    label: 'Flagship engineering tool'
  },
  {
    title: 'Lingora',
    image: '/projects/lingora.jpg',
    imageAlt: 'Cross-platform language learning system with connected semantic concepts and review cards',
    description:
  ...
  },
  {
    ...
    imageAlt: 'Offline-first digital library with reading, annotation, vocabulary, and synchronization tools',
    description:
...
const SupportingProject = ({ project }) => (
      ...
      <div className='mx-auto w-full max-w-[1048px] px-4 lg:px-8'>
        <header className='mx-auto mb-10 max-w-3xl text-center md:mb-12'>
          ...
          <p className='mx-auto mb-0 max-w-2xl text-slate-600 dark:text-slate-200'>
            Three products that bring together systems thinking, hands-on engineering, and architecture designed to hold
            up beyond the first release.
          </p>
        </header>
