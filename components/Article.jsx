...
const Article = ({ mdxSource }) => (
  <article
    ...
    className='prose prose-slate max-w-none text-base leading-relaxed dark:prose-invert sm:text-base sm:leading-8 lg:text-lg lg:leading-8
      ...
      prose-pre:my-6 lg:prose-pre:my-8 prose-pre:max-w-full prose-pre:overflow-x-auto prose-pre:rounded-xl prose-pre:p-0
      prose-code:break-words prose-code:text-[0.875em]
      prose-th:whitespace-nowrap prose-th:px-3 prose-th:py-2.5 sm:prose-th:px-4 sm:prose-th:py-3 prose-td:px-3 prose-td:py-2.5 sm:prose-td:px-4 sm:prose-td:py-3'
  >
    <ReactMarkdown
