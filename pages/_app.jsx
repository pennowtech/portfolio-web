  ...
  return (
    <>
      ...
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2??family=Barlow:wght@300;700&family=Comic+Neue:wght@700&family=Inter:wght@400&family=Noto+Sans+JP:wght@400&family=Roboto+Slab:wght@400;700&family=Merriweather&family=Fira+Code:wght@400&family=Roboto+Condensed&family=Monda&family=Neuton:wght@700&family=Offside&family=Rajdhani:wght@300;500&family=Yantramanav:wght@300;500&family=Barlow+Condensed&display=swap"
          rel="stylesheet"
        />
        <link
          rel="stylesheet"
