...
_Netlify_.
  ...
  6. Apart from the above, Netlify provides the options: 
    1. to roll back to previous versions,
    2. custom domains,
    3. function for serverless operations,
    4. command-line interface (CLI) to let you deploy or configure your websites straight from the command line,
    5. instant forms to collect user data, etc.
