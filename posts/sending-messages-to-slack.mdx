...
We already covered these statements in detail. If you need to refresh your concepts, then refer to the previous article on [how to get started with Slack](/slack-app-getting-started/).
