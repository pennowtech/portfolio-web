...
thumbnailUrl: "/my-first-mdx-file.jpg"
tags:
  - Guide
  - tutorials
  - Kafka
...
The purpose of this post is to show how easy and intuitive it can be to make a navbar in NextJS with the help of TailwindCSS. :dog: :+1:
